...
func (f *kubeInformerFactory) ResourceClaim() cache.SharedIndexInformer {
	return f.getInformer("resourceClaimInformer", func() cache.SharedIndexInformer {
		...
		return cache.NewSharedIndexInformer(lw, &resourcev1alpha3.ResourceClaim{}, f.defaultResync, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
	})
}
...
func (f *kubeInformerFactory) ResourceSlice() cache.SharedIndexInformer {
	return f.getInformer("resourceSliceInformer", func() cache.SharedIndexInformer {
		...
		return cache.NewSharedIndexInformer(lw, &resourcev1alpha3.ResourceSlice{}, f.defaultResync, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
	})
}
