...
DEFAULT_CLUSTER_NAME="kind-1.31-dra"
...
function up() {
    echo "${KUBEVIRTCI_PATH}/cluster/kind-1.31-dra/kind.yaml"
    cp ${KUBEVIRTCI_PATH}/cluster/kind-1.31-dra/kind.yaml ${KUBEVIRTCI_CONFIG_PATH}/$KUBEVIRT_PROVIDER/kind.yaml
